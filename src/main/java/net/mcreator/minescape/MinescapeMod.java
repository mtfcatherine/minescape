package net.mcreator.minescape;
...
import net.mcreator.minescape.init.MinescapeModTabs;
import net.mcreator.minescape.init.MinescapeModSounds;
import net.mcreator.minescape.init.MinescapeModItems;
import net.mcreator.minescape.init.MinescapeModEntities;
import net.mcreator.minescape.init.MinescapeModBlocks;
...
@Mod("minescape")
public class MinescapeMod {
	public static final Logger LOGGER = LogManager.getLogger(MinescapeMod.class);
	public static final String MODID = "minescape";

	public MinescapeMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MinescapeModSounds.REGISTRY.register(modEventBus);
		MinescapeModBlocks.REGISTRY.register(modEventBus);
		MinescapeModItems.REGISTRY.register(modEventBus);
		MinescapeModEntities.REGISTRY.register(modEventBus);
		MinescapeModTabs.REGISTRY.register(modEventBus);
		MinescapeModVariables.ATTACHMENT_TYPES.register(modEventBus);
