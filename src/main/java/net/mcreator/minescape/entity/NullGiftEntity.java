...
import net.mcreator.minescape.procedures.OnCollectProcedure;
import net.mcreator.minescape.init.MinescapeModEntities;

public class NullGiftEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public NullGiftEntity(EntityType<NullGiftEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void playerTouch(Player sourceentity) {
		...
		OnCollectProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinescapeModEntities.NULL_GIFT.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
