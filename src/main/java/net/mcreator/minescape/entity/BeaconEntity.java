...
import net.mcreator.minescape.procedures.OnBeaconProcedure;
import net.mcreator.minescape.init.MinescapeModEntities;

public class BeaconEntity extends Monster {
	public BeaconEntity(EntityType<BeaconEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void playerTouch(Player sourceentity) {
		...
		OnBeaconProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), sourceentity);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinescapeModEntities.BEACON.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
