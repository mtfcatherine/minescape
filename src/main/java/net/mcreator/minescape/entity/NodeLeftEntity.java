...
public class NodeLeftEntity extends Monster {
	public NodeLeftEntity(EntityType<NodeLeftEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinescapeModEntities.NODE_LEFT.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
