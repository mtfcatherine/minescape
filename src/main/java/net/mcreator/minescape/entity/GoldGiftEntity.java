...
public class GoldGiftEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public GoldGiftEntity(EntityType<GoldGiftEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinescapeModEntities.GOLD_GIFT.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
