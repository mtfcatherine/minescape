...
public class NodeRightEntity extends Monster {
	public NodeRightEntity(EntityType<NodeRightEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MinescapeModEntities.NODE_RIGHT.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
