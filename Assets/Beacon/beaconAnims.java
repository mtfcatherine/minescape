...
public class beaconAnimation {
	public static final AnimationDefinition Idle = AnimationDefinition.Builder.withLength(4.1667F).looping()
		.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(4.0F, KeyframeAnimations.degreeVec(-71.0F, -33.0F, 28.0F), AnimationChannel.Interpolations.CATMULLROM),
